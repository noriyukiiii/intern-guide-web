...
const UserNav = () => {
  ...
  return (
    <nav className="bg-[#ffffff] w-full py-4 px-10 font-Prompt flex justify-between items-center shadow-md shadow-gray-400 fixed top-0 z-20">
      ...
      <ul className="flex gap-[40px] items-center">
        ...
        {session?.user?.role === "ADMIN" ? <></> : <div className="text-red-300">ADMIN</div>}
        {session?.isLoading ? (
          <>
            <div>IS LOADING</div>
          </>
